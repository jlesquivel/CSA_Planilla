...
Public Class cCorreo
    Dim servidor As String = "mx1.hostinger.mx"
    Dim puerto As Integer = 587
    Dim ssl As Boolean = True
    Dim credenciales As Boolean = True

    Dim cuenta As String = "administracion@csalib.org"
    Dim contrasena As String = "csa123"

    Public Sub New(pDe As String, pPara As String, pasunto As String, pmsj As String, padjunto As String)
        enviar_mail(pDe, pPara, pasunto, pmsj, padjunto)
    End Sub

    Public Sub enviar_mail(ByVal i_de As String, ByVal i_para As String, ByVal asunto As String, ByVal mensaje As String, ByVal archivo As String)

        Dim insMail As New MailMessage(i_de, i_para)
        Dim adjunto As New System.Net.Mail.Attachment(archivo) ''  ruta del achivo adjunto
        ...
        With insMail
            ...
            .ReplyToList.Add(New MailAddress(i_de))
