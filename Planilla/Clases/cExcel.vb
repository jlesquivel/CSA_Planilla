...
#Region " Operaciones para llenar Plantilla con Nomina que se envia de pagos a Coopenade"
    Sub AbrePlantillaPlanilla(pArch As String)
        wdArch = renombrar1(pArch)
    ...
    Function renombrar1(pArch As String) As String
...
#Region "Caja Herramientas"
    Function AbreExcel(pArch As String) As Excel.Workbook
        wdApp = New Excel.Application
        wdApp.visible = False
        If File.Exists(pArch) Then
            objLibroExcel = wdApp.Workbooks.Open(pArch)
        End If
        Return objLibroExcel
    End Function

    Public Sub CerrarProcesoExcel()
        Dim p As Process
