...
Public Class ConstanciaSalario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.ConstanciaSalario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_id_emp() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedConstanciaSalario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConstanciaSalario = New ConstanciaSalario()
        rpt.Site = Me.Site
        Return rpt
    End Function
