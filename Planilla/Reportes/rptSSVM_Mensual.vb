...
Public Class rptSSVM_Mensual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.rptSSVM_Mensual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSSVM_Mensual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSSVM_Mensual = New rptSSVM_Mensual()
        rpt.Site = Me.Site
        Return rpt
    End Function
