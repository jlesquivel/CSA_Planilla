...
Public Class rptColillasPago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.rptColillasPago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptColillasPago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptColillasPago = New rptColillasPago()
        rpt.Site = Me.Site
        Return rpt
    End Function
