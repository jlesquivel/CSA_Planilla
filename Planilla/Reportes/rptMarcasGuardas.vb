...
Public Class rptMarcasGuardas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.rptMarcasGuardas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ced() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptMarcasGuardas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMarcasGuardas = New rptMarcasGuardas()
        rpt.Site = Me.Site
        Return rpt
    End Function
