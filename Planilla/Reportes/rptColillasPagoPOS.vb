...
Public Class rptColillasPagoPOS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.rptColillasPagoPOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptColillasPagoPOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptColillasPagoPOS = New rptColillasPagoPOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
